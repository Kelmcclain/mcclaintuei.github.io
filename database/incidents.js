...
const incidents = JSON.parse(localStorage.getItem('incidents')) || [
    {
        ...
        tags: ['commercial', 'assault', 'unconfirmed','medium','active'],
        author: 'McClain',
        date: '9/18',
        time:'6:41',
        updates:[]
        ...
        incidentId: 'x8WpAgX1Rbe6sdf333SNn37Uo8Fi',
        title: 'Residential Burglary',
        update: 'Police are responding to a report of a residential burglary.',
        address: 'N Avondale Blvd & W McDowell Rd, Avondale, AZ, USA',
        clip: 'SB194WcCSq0YkSQ',
        tags: ['commercial', 'assault', 'unconfirmed','medium','active'],
        author: 'McClain',
        ...
        incidentId: 'x8WpAgX1Rbe6333SNasn37Uosdf8Fi',
        title: 'Man Assaulted Person at Seattle Center',
        update: 'First responders are responding to a 911 report of a vehicle collision with injuries.',
        address: 'N Avondale Blvd & W McDowell Rd, Avondale, AZ, USA',
        clip: 'SB194WcCSq0YkSQ',
        tags: ['commercial', 'assault', 'unconfirmed','medium','active'],
